...
set output "perplexityNonUS.eps";
...
set xlabel "Region" font "Helvetica,25" offset 0,0.41
set ylabel "Perplexity" font "Helvetica,25"
set key spacing 1.7
set logscale y
set bmargin 6
#set grid
plot 'dat.perplexityNonUS' using ($3):xticlabels(1) title 'TM-ATAM' fs pattern 1, \

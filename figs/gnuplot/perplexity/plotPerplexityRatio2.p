set terminal postscript eps enhanced monochrome dashed font 'Helvetica,17'
set size 1,1
...
#set grid
set yrange [0:2.25]
plot 'dat.perplexityRatio2' using ($4):xticlabels(1) title 'ATAM' fs pattern 3, \
        '' using ($3):xticlabels(1) title 'TM-LDA' fs pattern 2, \
	'' using ($5):xticlabels(1) title 'LDA' fs pattern 6, \
    1 ls 3 title ""

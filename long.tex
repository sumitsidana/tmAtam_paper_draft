...
\author{
% 1st. author
\alignauthor Sumit Sidana, Sihem Amer-Yahia, Massih-Reza Amini,\\ Marianne Clausel, Etienne Dubl\'e \\
...
\input{./long/intro}
\input{./long/background}
\input{./long/approaches}
\input{./long/results}
\input{./long/relatedwork}
\input{./long/conclusion}
